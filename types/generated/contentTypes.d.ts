...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'attributes.seo', false>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categories: Schema.Attribute.Relation<
      ...
      'api::category.category'
    >;
    cover_media: Schema.Attribute.Media<
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    pricing: Schema.Attribute.Component<'attributes.price', false>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'attributes.seo', false>;
...
export interface ApiVariantVariant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    media: Schema.Attribute.Media<'files' | 'images', true>;
    name: Schema.Attribute.String;
